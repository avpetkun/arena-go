## Full native implementation go arena

For those who want to use memory arenas before the official release

Documentation from runtime package:

```go
// Implementation of (safe) user arenas.
//
// This package contains the implementation of user arenas wherein Go values can
